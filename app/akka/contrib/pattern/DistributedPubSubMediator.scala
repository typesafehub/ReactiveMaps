...
object DistributedPubSubMediator {
  ...
  def props(
    ...
    Props(classOf[DistributedPubSubMediator], role, gossipInterval, removedTimeToLive, maxDeltaElements)
  ...
  def props(
    ...
    props(Internal.roleOption(role), gossipInterval, removedTimeToLive, maxDeltaElements)
